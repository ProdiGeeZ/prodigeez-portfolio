...
const Sidebar = () => {
    return (
        <>
            <div className="fixed top-1/2 left-0 transform -translate-y-1/2 flex flex-col items-center gap-12 md:gap-16 p-1 md:p-3 hover:p-4 bg-gradient-to-tl from-dark-frosted-dark/25 to-frosted-dark backdrop-blur-xl rounded-r-md shadow-2xl dark:bg-gradient-to-tl dark:from-dark-frosted-light/10 dark:to-dark-frosted-dark opacity-50 hover:opacity-100 focus-within:opacity-100 transition-all ease-in-out duration-300">
