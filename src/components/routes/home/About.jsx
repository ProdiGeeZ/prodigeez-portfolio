...
function About() {
    return (
        <div className="sm:px-10 py-12 w-full min-h-screen grid grid-cols-1 lg:grid-cols-2 justify-center items-center">
            ...
            <div className="flex flex-col justify-center text-left px-4 md:px-10">
                ...
                <p className="leading-relaxed text-base md:text-lg mb-2">
                ...
                <Button href="/projects" className="inline-flex items-center justify-center px-4 py-2 text-md md:text-base rounded-md font-semibold transition ease-in-out">
