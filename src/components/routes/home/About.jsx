    ...
    return (
        <div className="w-full flex flex-col mt-12 md:flex-row px-10 py-12 justify-center h-auto md:h-[100vh] md:px-80 md:pt-[150px]">
            ...
            <div className="w-full mt-4">
                ...
                <Button href="/projects" className="inline-flex items-center justify-center w-44 md:w-auto px-6 py-2 md:text-base text-md rounded-md font-semibold lg:text-lg lg:mb-6 hover:bg-[#fd8d8d] transition ease-in-out delay-150">
